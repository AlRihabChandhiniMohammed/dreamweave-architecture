...
export function Contact() {
  ...
  const waHref = company.phoneRaw ? `https://wa.me/${company.phoneRaw}` : "#contact";
  const telHref = company.phoneRaw ? `tel:+${company.phoneRaw}` : "#contact";
              ...
              <li>
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="text-sm text-foreground group-hover:text-accent">
                      {company.phoneRaw ? company.phoneDisplay : "[Add phone number to activate]"}
                    </span>
                  </span>
                </a>
              </li>
          ...
          <Reveal delay={0.1}>
            ...
            >
              ...
              <div>
                ...
                <input id="location" name="location" placeholder="City / area" className={fieldClass} />
              </div>
              <div>
                <label htmlFor="plot" className="eyebrow">
                  Plot Size
                </label>
                <input id="plot" name="plotSize" placeholder="e.g. 30x40 ft" className={fieldClass} />
              </div>
              <div>
                <label htmlFor="budget" className="eyebrow">
                  Approximate Budget
                </label>
                <input id="budget" name="budget" placeholder="Approximate range" className={fieldClass} />
              </div>
              <div>
